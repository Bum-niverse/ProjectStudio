    ...
    <main className="app-shell page-shell">
      ...
      {page === "features" && selectedProject && (
        <section className="full-page feature-page">
          {isDataProject(selectedProject.project.projectType)?<DataDesignPage projectId={selectedProject.project.id} projectType={selectedProject.project.projectType} projectSubtype={selectedProject.project.projectSubtype}/>:<FeatureMap projectId={selectedProject.project.id} projectName={selectedProject.project.name} projectIdea={selectedProject.project.idea} sourceDocumentId={selectedProject.prd.documentId} />}
